...
inputNumberOne: .asciiz "Please input first number Ex: 1223 \n"
inputNumberTwo: .asciiz "Please input second number Ex: 3334 \n"
inputOperator: .asciiz "Press a to add two number \nPress b to subtract two number\nPress c to multiply two number\nPress d to divide two number\nPress e to find x^y (x: first number, y: second number) \n"
...
choosePow: .asciiz "You chose the power operation \n"
choosePrint: .asciiz "Please press f to print the result \n"
choosedPrint: .asciiz "You chose f to print the result \n"
result: .asciiz "The result of operator is "
remainder: .asciiz " and remainder is: "
end: .asciiz "End of program \n"
thanks: .asciiz "Thanks for using this calculator \n"
overflow: .asciiz "The result is overflow!!! \n"
...
# 1: is sum, 2: is sub, 3: is mul, 4: is div, 5: is pow
getOperator: 
...
getEqual:
  ...
  switchEqualOperator:
    ...
    case_mul_handler:
      ...
      j HandleResult
    case_div_handler:
      bne $s2, 4 , case_pow_handler
      beq $s4, $zero, case_error_handler
      div $t8, $s3, $s4
      #print
      li $v0, 4
      la $a0, result
